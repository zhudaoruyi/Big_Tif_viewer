...
def transformlat(lng, lat):
    ...
    print ("transformed latitude\t", ret)
    return ret
...
def transformlng(lng, lat):
    ...
    print ("transformed longitude\t", ret)
    return ret
...
if __name__ == '__main__':
    ...
    print ("mercart", deg2num(lat, lng, 17))
    print ("y, x", deg2num(36.7101, 117.0815, 17))
    print ("1y, x", gps2mct(116.6482, 36.6757))
    print ("2y, x", deg2num(36.6757, 116.6482, 18))
    print ("2y, x", deg2num(36.6757, 116.6482, 22))
    print ("2y, x", deg2num(36.6757, 116.6482, 23))

    #result9 = regeocode_gd(str(117.078247) + ',' + str(36.705871))
    #print ("***\n", result9)
